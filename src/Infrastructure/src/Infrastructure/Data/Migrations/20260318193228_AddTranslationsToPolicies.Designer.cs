...
namespace Infrastructure.src.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260318193228_AddTranslationsToPolicies")]
    partial class AddTranslationsToPolicies
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.CancellationPolicyEntity", b =>
                {
                    ...
                    b.Property<Dictionary<string, CancellationPolicyTranslationData>>("Translations")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.HasIndex("TourScope", "MinDaysBeforeDeparture", "MaxDaysBeforeDeparture", "Status", "IsDeleted");
            ...
            modelBuilder.Entity("Domain.Entities.DepositPolicyEntity", b =>
                {
                    ...
                    b.Property<Dictionary<string, DepositPolicyTranslationData>>("Translations")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Domain.Entities.PricingPolicy", b =>
                {
                    ...
                    b.Property<Dictionary<string, PricingPolicyTranslationData>>("Translations")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Domain.Entities.VisaPolicyEntity", b =>
                {
                    ...
                    b.Property<Dictionary<string, VisaPolicyTranslationData>>("Translations")
                        .IsRequired()
                        .HasColumnType("jsonb");
