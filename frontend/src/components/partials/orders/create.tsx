  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = extractItems<any>(response.data).filter(
            (product: any) =>
              product.published === true && product.status === 1,
          );
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const createdResult = extractResult<any>(response.data);
        if (createdResult) {
          toast.success(t("orders.createSuccess"));
          router.push(`/orders/${createdResult?.id || createdResult}`);
        }
      } catch (error) {
                  ...
                  <Textinput
                    ...
                    error={
                      formik.touched.customerName && formik.errors.customerName
                        ? { message: formik.errors.customerName }
                        : undefined
                    }
                  />
                </div>
                    ...
                    <Textinput
                      ...
                      error={
                        ...
                        formik.errors.customerEmail
                          ? { message: formik.errors.customerEmail }
                          : undefined
                      }
                    />
                  </div>
                    ...
                    <Textinput
                      ...
                      error={
                        ...
                        formik.errors.customerPhoneNumber
                          ? { message: formik.errors.customerPhoneNumber }
                          : undefined
                      }
                    />
                  </div>
                  ...
                  <Textarea
                    ...
                    error={
                      ...
                      formik.errors.shippingAddressLine
                        ? { message: formik.errors.shippingAddressLine }
                        : undefined
                    }
                  />
                </div>
                    ...
                    <Textinput
                      ...
                      error={
                        ...
                        formik.errors.shippingSubdivision
                          ? { message: formik.errors.shippingSubdivision }
                          : undefined
                      }
                    />
                  </div>
                    ...
                    <Textinput
                      ...
                      error={
                        ...
                        formik.errors.shippingCity
                          ? { message: formik.errors.shippingCity }
                          : undefined
                      }
                    />
                  </div>
                    ...
                    <Textinput
                      ...
                      error={
                        ...
                        formik.errors.shippingStateOrProvince
                          ? { message: formik.errors.shippingStateOrProvince }
                          : undefined
                      }
                    />
                  </div>
                    ...
                    <Textinput
                      ...
                      error={
                        ...
                        formik.errors.shippingCountry
                          ? { message: formik.errors.shippingCountry }
                          : undefined
                      }
                    />
                  </div>
                    ...
                    <Textinput
                      ...
                      error={
                        ...
                        formik.errors.shippingPostalCode
                          ? { message: formik.errors.shippingPostalCode }
                          : undefined
                      }
                    />
                  </div>
            ...
            <Card title={t("orders.orderItems")}>
              <div className="space-y-4">
                {orderItems.map((item, index) => (
                  <div
                    key={index}
                    className="flex items-end gap-4 rounded-lg border border-slate-200 p-4 dark:border-slate-700"
                  >
          ...
          <div className="col-span-12 space-y-5 lg:col-span-4">
            ...
            <Card>
              <div className="space-y-3">
                ...
                <Link
                  href="/orders"
                  className="btn btn-outline-dark inline-flex w-full items-center justify-center"
                >
                  {t("common.cancel")}
                </Link>
              </div>
