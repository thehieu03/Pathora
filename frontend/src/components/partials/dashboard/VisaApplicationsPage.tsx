  ...
  return (
    <header className="sticky top-0 z-40 bg-white border-b border-slate-200 h-16 flex items-center px-6 gap-4">
      ...
      <div className="relative flex-1 max-w-xl">
        ...
        <label htmlFor="visa-search" className="sr-only">Search</label>
        <input id="visa-search" type="text" placeholder="Search visa applications..." className="w-full pl-10 pr-4 py-2 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500" />
      </div>
