      ...
      return (
        <div>
          <span className="inline-flex items-center">
            ...
            <span className="text-sm font-medium text-slate-600 capitalize dark:text-slate-300">
              {row?.cell?.value.name}
            </span>
          </span>
        </div>
      ...
      return (
        <span className="block w-full">
          <span
            ...
            } ${row?.cell?.value === "due" ? "text-warning-500" : ""} ${row?.cell?.value === "cancled" ? "text-danger-500" : ""} `}
          >
                  ...
                  <div
                    className={` ${
                      item.name === "delete"
                        ...
                        : "dark:hover:bg-opacity-50 hover:bg-slate-900 hover:text-white dark:hover:bg-slate-600"
