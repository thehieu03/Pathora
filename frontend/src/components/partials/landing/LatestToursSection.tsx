...
const FALLBACK_TOURS = [
  {
    image: "https://www.figma.com/api/mcp/asset/b9cd8d76-4d7f-43c8-b45b-122fe4f71260",
    title: "Discover the Hidden Gems of Vietnam",
    createdAt: "2024-01-15",
  },
  {
    image: "https://www.figma.com/api/mcp/asset/32fbeb93-7522-491f-9f41-13605309640b",
    title: "Adventure in the Mountains",
    createdAt: "2024-01-10",
  },
  {
    image: "https://www.figma.com/api/mcp/asset/6cf6a7f0-afb4-4b77-95a1-4d4cce07178b",
    title: "Beach Paradise Escapes",
    createdAt: "2024-01-08",
  },
  {
    image: "https://www.figma.com/api/mcp/asset/b04dae5c-2842-4319-b4b3-27e85c19b69e",
    title: "Cultural Heritage Tour",
    createdAt: "2024-01-05",
  },
  {
    image: "https://www.figma.com/api/mcp/asset/0389d41e-0d8e-4b36-ae47-43f762b15938",
      ...
      <SectionContainer>
        <section className="w-full">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8 overflow-x-auto pb-2">
            {[...Array(5)].map((_, idx) => (
              <div key={idx} className="flex flex-row md:flex-col items-center gap-3 md:gap-3 shrink-0 w-full md:w-auto">
