      ...
      <ul className="list-item h-full space-y-3 overflow-x-auto">
        {activity.map((item, i) => (
          ...
          >
            ...
            <div className="max-w-[63%] overflow-hidden text-start text-ellipsis whitespace-nowrap">
              <div className="overflow-hidden text-sm text-ellipsis whitespace-nowrap text-slate-600 dark:text-slate-300">
