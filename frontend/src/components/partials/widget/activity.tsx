  ...
  return (
    <ul className="relative ltr:pl-2 rtl:pr-2">
      {lists.map((item, i) => (
        <li
          ...
          className={`
               ${
                 ...
                 last:border-none ltr:pl-5.5 rtl:pr-5.5 relative before:absolute ltr:before:left-[-8px] 
                 rtl:before:-right-2 before:top-0 before:rounded-full before:w-4 before:h-4
                  before:bg-slate-900 dark:before:bg-slate-600 before:leading-0.5 
        ...
        >
          <div className="p-2.5 relative top-[-20px]">
