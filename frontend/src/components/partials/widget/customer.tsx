    ...
    <div className="pb-2">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
        {customers.map((item, i) => (
          ...
          >
            ...
            <div>
              <div className="mt-4 mb-3 flex justify-between text-sm font-normal dark:text-slate-300">
                <span>Progress</span>
      ...
      <div className="mt-5 grid grid-cols-1 gap-5">
        {customers2.map((item, i) => (
          <div
            key={i}
            className="bg-gray-5003 relative z-1 items-center space-y-3 rounded-sm p-4 md:flex md:space-y-0 md:space-x-10 rtl:space-x-reverse dark:bg-slate-900"
          >
            <div
              className={`${
                item.active ? "ring-2 ring-[#FFC155]" : ""
            ...
            >
              ...
              <img
                ...
                className="h-full w-full rounded-full"
              />
              <span className="absolute right-0 bottom-0 flex h-4 w-4 flex-col items-center justify-center rounded-full border border-white bg-[#FFC155] text-[10px] font-medium text-white">
                {item.number}
              </span>
            </div>
