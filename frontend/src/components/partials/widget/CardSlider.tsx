    ...
    <div>
      <Swiper effect={"cards"} grabCursor={true} modules={[EffectCards]}>
        {cardLists.map((item, i) => (
          <SwiperSlide key={i}>
            <div
              className={`${item.bg} relative z-1 h-[200px] rounded-md bg-linear-to-r p-4 text-white`}
            >
              ...
              <div className="mt-[18px] mb-[17px] text-lg font-semibold">
                {item.cardNo}
              </div>
              <div className="text-opacity-75 mb-[2px] text-xs">
                Card balance
              </div>
