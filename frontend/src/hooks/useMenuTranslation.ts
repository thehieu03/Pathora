      ...
      if (item.megamenu) {
        translated.megamenu = item.megamenu.map((mega) => {
          ...
          if (mega.megamenutitle) {
            ...
            translatedMega.megamenutitle = t(
              translationKey,
              mega.megamenutitle,
            );
          }
          ...
          if (mega.singleMegamenu) {
            translatedMega.singleMegamenu = mega.singleMegamenu.map(
              (single) => {
                const translatedSingle: TranslatedSingleMegaMenuItem = {
                  ...single,
                };
                if (single.m_childtitle) {
                  const translationKey = getTranslationKey(single.m_childtitle);
                  translatedSingle.m_childtitle = t(
                    translationKey,
                    single.m_childtitle,
                  );
                }
