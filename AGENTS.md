...
This project is indexed by GitNexus as **pathora** (2097 symbols, 3858 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
