...
This project is indexed by GitNexus as **pathora** (2085 symbols, 3843 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
