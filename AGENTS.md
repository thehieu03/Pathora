...
This project is indexed by GitNexus as **pathora** (2110 symbols, 3896 relationships, 50 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
