...
This project is indexed by GitNexus as **pathora** (2027 symbols, 3775 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
This project is indexed by GitNexus as **pathora** (2071 symbols, 3816 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
