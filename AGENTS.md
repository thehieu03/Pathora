...
This project is indexed by GitNexus as **pathora** (2116 symbols, 3932 relationships, 50 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
