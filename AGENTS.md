...
This project is indexed by GitNexus as **pathora** (1823 symbols, 3453 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
