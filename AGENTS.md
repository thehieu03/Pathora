...
This project is indexed by GitNexus as **pathora** (2053 symbols, 3791 relationships, 41 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
