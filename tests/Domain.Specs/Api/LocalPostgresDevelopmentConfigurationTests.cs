...
{
    [Fact]
    public void ConnectionString_WhenLoadingDevelopmentConfig_ShouldUseLocalhostForHostRun()
    {
        ...
        Assert.DoesNotContain("duckdns.org", connectionString, StringComparison.OrdinalIgnoreCase);
    }

    [Fact]
    public void DotEnvConnectionString_WhenUsingLocalCompose_ShouldUsePostgresHost()
    {
        ...
        Assert.Contains("Host=postgres", connectionLine!, StringComparison.OrdinalIgnoreCase);
        Assert.DoesNotContain("duckdns.org", connectionLine, StringComparison.OrdinalIgnoreCase);
    }
