...
public sealed class DepositPolicyServiceTests
{
    ...
    public async Task GetAllAsync_WhenPoliciesExist_ShouldReturnAllPolicies()
    {
        ...
        {
            CreateTestPolicy(TourScope.Domestic, DepositType.Percentage, 10, 7),
            CreateTestPolicy(TourScope.International, DepositType.FixedAmount, 500, 14)
        };
    ...
    {
        var policy = CreateTestPolicy(TourScope.Domestic, DepositType.Percentage, 10, 7);
    ...
    private static DepositPolicyEntity CreateTestPolicy(TourScope tourScope, DepositType depositType, decimal depositValue, int minDays)
    {
